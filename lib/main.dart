  ...
  Widget _buildSidebar(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: activeTheme.surfaceColor.withOpacity(isDark ? 0.4 : 0.8),
        border: Border(
          right: BorderSide(
            color: activeTheme.primaryColor.withOpacity(0.12),
            width: 1,
          ),
        ),
      ),
              ...
              style: TextStyle(
                  ...
                  shadows: [
                    if (activeTheme.glowEffect)
                      Shadow(
                        color: activeTheme.primaryColor.withOpacity(0.8),
                        blurRadius: 10,
                      )
                  ]),
            ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            if (!isVerySmall) ...[
              _buildStatChip(
                  'FPS', '${_fps.toStringAsFixed(1)} Hz', Colors.green, isMobile),
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                activeTheme.secondaryColor.withOpacity(0.05),
              ],
            ),
            borderRadius: BorderRadius.circular(20),
            border:
                Border.all(color: activeTheme.primaryColor.withOpacity(0.2)),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: active
                  ? activeTheme.primaryColor.withOpacity(0.08)
      ...
      children: [
        ...
        Center(
          child: MotionCard(
            ...
            elevation: 10,
            borderRadius: 24,
            shadowColor: activeTheme.primaryColor.withOpacity(0.25),
            child: Container(
              width: 300,
              height: 180,
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    activeTheme.primaryColor.withOpacity(0.7),
                    activeTheme.secondaryColor.withOpacity(0.7),
                  ],
                ),
              ),
              padding: const EdgeInsets.all(20),
              child: Column(
                ...
                children: [
                  ...
                  const Spacer(),
                  const Text('4000 1284 5691 0032',
                      style: TextStyle(
                          fontFamily: 'monospace',
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: activeTheme.surfaceColor
            .withOpacity(activeTheme.isDark ? 0.4 : 0.8),
        border: Border(
          left: BorderSide(
            color: activeTheme.primaryColor.withOpacity(0.12),
            width: 1,
