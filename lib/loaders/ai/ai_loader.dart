...
class _AiPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(rect, outerAngleStart + math.pi, math.pi * 0.6, false, outerPaint);

    // 2. Draw middle ring rotating counter-clockwise
    final midPaint = Paint()
      ..color = Color.lerp(color, Colors.cyan, 0.5)!.withOpacity(0.6)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 2.0
      ..strokeCap = StrokeCap.round;
    ...
    canvas.drawArc(midRect, midAngleStart + math.pi, math.pi * 0.4, false, midPaint);
